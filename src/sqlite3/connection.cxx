...
sqlite3pp::sqlite3::connection::~connection() {
    close();
}

auto sqlite3pp::sqlite3::connection::close() -> error {
...
auto sqlite3pp::sqlite3::make_connection(const char *filename, open_option options) -> expected<connection> {
...
auto sqlite3pp::sqlite3::make_connection(const char *filename) -> expected<connection> {
    ::sqlite3 *connection_ptr = nullptr;
